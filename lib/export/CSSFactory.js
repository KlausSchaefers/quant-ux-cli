...
function () {
  ...
  _createClass(_default, [{
    ...
    value: function getAbsolutePosition(widget) {
      ...
      var h = widget.h;
      var top = widget.y;
      var left = Math.max(0, widget.x - this.marginWhiteSpaceCorrect); // let right = widget.parent ? Math.max(0, (widget.parent.w - (widget.x  + widget.w) - this.marginWhiteSpaceCorrect)) : 0
