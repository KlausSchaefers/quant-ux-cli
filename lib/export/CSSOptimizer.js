  ...
  _createClass(CSSOptimizer, [{
    ...
    value: function compressList(list) {
      ...
      Object.values(list).forEach(function (item) {
        item.style = _this.compress(item.style, item);
      });
    }
  }, {
    key: "compress",
    value: function compress(style) {
      ...
      var styleIsEqual = this.compressAttribes(style, this.borderStyle, 'borderStyle', false, 'solid'); // this.compressAttribes(style, this.padding, 'padding', 'px', 0)
