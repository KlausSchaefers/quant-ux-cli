  ...
  _createClass(ModelTransformer, [{
    ...
    value: function computeGrid(parent) {
      ...
      if (parent.children && parent.children.length > 0) {
        ...
        parent.children.forEach(function (c) {
          _this3.addGridColumns(columns, c.x, c, true);

          _this3.addGridColumns(columns, c.x + c.w, c, false);

          _this3.addGridRow(rows, c.y, c, true);

          _this3.addGridRow(rows, c.y + c.h, c, false);
        });
        /**
    ...
    value: function setOrderAndRelativePositons(parent, relative) {
      ...
      nodes.forEach(function (n) {
        if (n.children && n.children.length > 0) {
          _this4.setOrderAndRelativePositons(n, relative);
        }
      });
      return parent;
    }
    ...
    value: function cleanUpContainer(parent) {
      ...
      nodes.forEach(function (node) {
        if (node.children.length === 1) {
          ...
          if (_this7.isEqualBox(node, child)) {
      ...
      for (var column in columns) {
        ...
        if (hasParent) {
          (function () {
            ...
            var container = {
              id: 'c' + _this8.columnContainerID++,
              name: "Column ".concat(_this8.columnContainerID),
              children: children,
              x: boundingBox.x,
              y: boundingBox.y,
              h: boundingBox.h,
            ...
            children.forEach(function (c) {
              ...
              _this8.mergeInResponsive(container, c);
            });
    ...
    value: function addColumns(parent) {
      ...
      nodes.forEach(function (a) {
        ...
        nodes.forEach(function (b) {
          if (a.id !== b.id) {
            if (_this9.isOverLappingX(a, b) && a.parent) {
    ...
    value: function addRowContainer(parent) {
      ...
      var _loop3 = function _loop3(row) {
        ...
        var boundingBox = Util.getBoundingBoxByBoxes(children);
        var container = {
          id: 'r' + _this10.rowContainerID++,
          name: "Row ".concat(_this10.rowContainerID),
          children: children,
          x: boundingBox.x,
          y: boundingBox.y,
          h: boundingBox.h,
        ...
        children.forEach(function (c) {
          ...
          _this10.mergeInResponsive(container, c);
        });
        newChildren.push(container);
      };
    ...
    value: function transformScreenToTree(screen) {
      ...
      widgets.forEach(function (widget) {
        var element = _this12.clone(widget);
        ...
        var parentWidget = _this12.getParentWidget(parentWidgets, element);
