...
var HTMLGenerator = /*#__PURE__*/function () {
  ...
  _createClass(HTMLGenerator, [{
    ...
    value: function run(app, conf) {
      var generator = new _Generator["default"](new _HTMLFactory["default"](conf), new _CSSFactory["default"](conf.css.grid, conf.css.prefix, true));
