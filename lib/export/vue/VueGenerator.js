...
function () {
  ...
  _createClass(VueGenerator, [{
    ...
    value: function run(app, conf) {
      var generator = new _Generator["default"](new _VueFactory["default"](conf), new _CSSFactory["default"](conf.css.responsive, conf.css.prefix, true));
      var result = generator.run(app, conf.css.responsive);
